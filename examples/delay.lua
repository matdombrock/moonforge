...
local delay_ticks = mfl.time.beat_to_ticks(bpm, 1.5)
local delay_ticks2 = mfl.time.beat_to_ticks(bpm, 2)
...
effect_set(1, "DELAY", delay_ticks, 0.5, 0.2)
effect_set(1, "DELAY", delay_ticks2, 0.5, 0.6)
wave_set(1, "SQUARE")
pan_set(1, 1, 0)
wave_set(2, "SQUARE")
